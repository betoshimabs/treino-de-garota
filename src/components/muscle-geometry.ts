...
export const frontPatches: MusclePatch[] = [
  ...
  { region: 'obliques', path: 'M65 119 Q70 120 76 125 C78 138 76 149 78 160 L67 167 C70 151 72 143 65 119Z', mirrored: true },
  { region: 'hips', path: 'M65 174 Q70 169 78 171 C76 181 67 190 59 199 Q57 186 65 174Z', mirrored: true },
...
export const backPatches: MusclePatch[] = [
  { region: 'shoulders', path: shoulders, mirrored: true },
  { region: 'upperBack', path: 'M84 71 Q78 77 69 80 C66 91 68 106 76 115 L87 129 L87 84Z', mirrored: true },
  { region: 'lats', path: 'M63 111 Q72 119 83 132 L80 156 Q74 157 69 151 C70 137 66 127 63 111Z', mirrored: true },
  ...
  { region: 'forearms', path: forearm, mirrored: true },
  { region: 'hips', path: 'M64 170 Q70 166 75 167 L73 179 Q63 183 59 195 Q58 181 64 170Z', mirrored: true },
